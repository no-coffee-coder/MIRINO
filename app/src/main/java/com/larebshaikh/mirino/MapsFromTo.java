...
public class MapsFromTo extends UsersOptionMenu implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       getSupportActionBar().setTitle("Mosque Route");
        ...
        if(!toLat.equals(null)||!toLong.equals(null))
        {
            ...
            Toast.makeText(this,"Didn't Got Any Longitude Latitude, Exiting Activity",Toast.LENGTH_SHORT).show();
    ...
    public void getIncomingIntents(){
        if(getIntent().hasExtra("latitude")&&getIntent().hasExtra("longitude")){
            ...
            Toast.makeText(this,"Lat :"+toLat+" Long"+toLong,Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if(isFirstTime){
            ...
            getDirection.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new FetchURL(MapsFromTo.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
                }
            });

            place1 = new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title("Your Location ");
            place2 = new MarkerOptions().position(new LatLng(lat, lon)).title("Mosque Location");
